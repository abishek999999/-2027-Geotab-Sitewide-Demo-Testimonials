...
(function () {
  ...
  // test 1003 Inject the video background into formSection
  ...
  function initVar() {
    var submitCTAInterval = setInterval(async function () {
      if (
        ...
        hiddenValue("spiralyze_conversion_tag_demo", "1014_V1");
        ...
        const copysectionTemplate = `
                <div class="copySectionContainer">
                    ...
                    alt="stars"
                    />
                    <h4>$50K/mo drop in idling costs</h4>
                    <p>
                    A game changer. It’s helped us manage aspects of our fleet that we
                    couldn’t get from anyone else. 
                    </p>
                    <div class="copySectionContact">
                    <img
                        src="//res.cloudinary.com/spiralyze/image/upload/f_auto/geotab/1014/avatar_1.webp"
                        alt="Nick Donahoe"
                    />
                    <div>
                        <h5>Nick Donahoe</h5>
                        <p>Director of Logistics</p>
                        <p>California Freight</p>
                    </div>
                    </div>
                </div>
                `;
          ...
          .addEventListener("click", function () {
            ...
            if (allFieldsFilled === checkfields.length) {
              ...
              if (isValidEmail(email)) {
                ...
                document
                  .querySelector(".spz_t1014 .formWrapper .MuiGridLegacy-item")
        ...
        function step2Visible() {
          if (
            document.querySelector(
              ".spz_t1014 .formWrapper .MuiGridLegacy-item.step1Filled"
            )
          ) {
            document
              .querySelectorAll(
        ...
        observeElementChanges(
          ".spz_t1014 .formWrapper .MuiGridLegacy-item",
          "childList",
          function (mutation) {
            if (
              document.querySelectorAll(
      ...
      // form text changes
      document.querySelector(".spz_t1014 .formWrapper h2").innerHTML =
        "Contact sales";
