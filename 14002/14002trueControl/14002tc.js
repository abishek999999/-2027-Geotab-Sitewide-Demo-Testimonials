...
(function () {
  ...
  function initVar() {
    ...
    hiddenValue("spiralyze_conversion_tag_demo", "14002_TC");
    ...
    document.querySelectorAll("button").forEach((button) => {
      if (
        ...
        if (button.innerText.toLocaleLowerCase() == "get prices") {
          button.classList.add("spz_14002_TC_cta");
        }
      }
    });
    ...
    var isDesk = window.outerWidth >= 960;
    var isTable = !isDesk;
  ...
  //               if (
  //                 document.querySelector(
  //                   ".spz_t14002_TC .formPopup .closeIconWrapper + .MuiGrid-root"
  //                 )
  //               ) {
  //                 document
  //                   .querySelector(
  ...
  //               if (
  //                 document.querySelector(
  //                   ".spz_t14002_TC .formPopup .closeIconWrapper"
  //                 ) &&
  ...
  //                 document
  //                   .querySelector(".spz_t14002_TC .formPopup .formWrapper")
  //                   .insertAdjacentHTML(
  //                     "afterend",
  //                     `
  //                                             <div class="details">
  ...
  //                 var splide = new Splide(".clientReviews", {
  //                   autoplay: true,
  //                   type: "loop",
  //                   perPage: 2,
  //                   pagination: false,
  ...
  //                 if (
  //                   document.querySelector(
  //                     ".spz_t14002_TC .formPopup .formWrapper + .details"
  //                   )
  //                 ) {
  //                   document
  //                     .querySelector(".spz_t14002_TC .formPopup .formWrapper")
  ...
  //                       "beforeend",
  //                       document.querySelector(
  //                         ".spz_t14002_TC .formPopup .details"
  //                       )
  //                     );
  //                 }
  //               }
  ...
  //             if (
  //               document.querySelectorAll("form#generic-lead-form h2").length >
  //                 0 &&
  //               document.querySelectorAll(
  ...
  //                 headingWrapper.parentElement.classList.add("headingWrapper");
  ...
  //               document
  //                 .querySelector(
  //                   ".spz_t14002_TC .formPopup form#generic-lead-form > div:nth-child(1)"
  //                 )
  //                 .classList.add("firstfieldsWrapper");
  //               document
  //                 .querySelector(
  //                   ".spz_t14002_TC .formPopup form#generic-lead-form > div:nth-child(2)"
  //                 )
  ...
  //                 '.spz_t14002_TC form#generic-lead-form .form-field .form-field__wrapper1 div[aria-haspopup="listbox"]'
  //               );
  //               if (targetElements) {
  ...
  //               // Changing Labels
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="first-name"]'
  //               ).innerHTML = "First name";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="last-name"]'
  //               ).innerHTML = "Last name";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="title"]'
  //               ).innerHTML = "Job title";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="email"]'
  //               ).innerHTML = "Email";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="phone-number"]'
  //               ).innerHTML = "Phone";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="self-attribution"]'
  ...
  //                       document
  //                         .querySelector(
  //                           ".spz_t14002_TC .formPopup form#generic-lead-form .stepCTAWrapper > div:first-child button"
  //                         )
  //                         .click();
  //                       setTimeout(() => {
  //                         bothFormsInitialSetup();
  ...
  //                       if (
  //                         (emptyFields[0].getAttribute("name") == "Title__c" ||
  ...
  //                           ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.title + div"
  //                         );
  //                         if (otherField) {
  ...
  //                         document
  //                           .querySelector("form#generic-lead-form #user_title")
  ...
  //                 ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.phone-number, .spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.self-attribution"
  //               );
  //               hiddenFields.forEach((field) => {
  //                 field.classList.add("hiddenField");
  //               });
  //               var visibleFields = document.querySelectorAll(
  //                 ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.first-name input, .spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.last-name input, .spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.email input, .spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.title input, .spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.title select"
  //               );
  ...
  //                 if (
  //                   document.querySelector(
  //                     ".spz_t14002_TC .formPopup form#generic-lead-form .firstfieldsWrapper h2"
  //                   )
  //                 ) {
  //                   document
  //                     .querySelector(
  ...
  //               // Changing Labels
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="company"]'
  //               ).innerHTML = "Company name";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="industry"]'
  //               ).innerHTML = "Industry";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="fleet-size"]'
  //               ).innerHTML = "Fleet size";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="country"]'
  //               ).innerHTML = "Country";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="city"]'
  //               ).innerHTML = "City";
  //               document.querySelector(
  //                 '.spz_t14002_TC form#generic-lead-form .fieldsWrapper label[for="multiple_region"]'
  ...
  //                   if (
  //                     document.querySelector(
  //                       ".spz_t14002_TC .formPopup form#generic-lead-form > div:nth-child(2) .fieldsWrapper > .stepCTAWrapper label > span:first-child"
  //                     )
  //                   ) {
  ...
  //               if (
  //                 document.querySelectorAll(
  //                   ".spz_t14002_TC form#generic-lead-form .fieldsWrapper .form-field.country div[aria-haspopup]"
  //                 ).length > 0
  //               ) {
  //                 observeElementChanges(
  //                   ".spz_t14002_TC form#generic-lead-form .fieldsWrapper .form-field.country div[aria-haspopup]",
  ...
  //                             if (
  //                               document.querySelector(
  //                                 ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.subIndustry"
  //                               )
  //                             ) {
  //                               document
  //                                 .querySelector(
  //                                   ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.country"
  //                                 )
  //                                 .classList.remove("fullWidth");
  //                               document
  //                                 .querySelector(
  //                                   ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.city"
  //                                 )
  ...
  //                             if (
  //                               document.querySelector(
  //                                 ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.state"
  //                               )
  //                             ) {
  //                               document.querySelector(
  //                                 ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.state"
  ...
  //                           if (
  //                             document.querySelector(
  //                               ".spz_t14002_TC form#generic-lead-form label#country-input-label"
  //                             )
  //                           ) {
  ...
  //                 ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.multiple_region label input"
  //               );
  ...
  //                   document.querySelectorAll(
  //                     ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.multiple_region label"
  //                   )
  //                 )
  //                   .map(
  //                     (option) => `
  ...
  //                     var selectedOptionsText = Array.from(checkedCheckboxes)
  //                       .map((opt) => opt.closest("label").textContent.trim())
  //                       .join(", ");
  ...
  //               document
  //                 .querySelector(
  //                   ".spz_t14002_TC .formPopup form#generic-lead-form .stepCTAWrapper button[type=submit]"
  //                 )
  //                 .removeAttribute("disabled");
  //               document
  //                 .querySelector(
  ...
  //                     !document.querySelector(
  //                       ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field p.MuiFormHelperText-root"
  //                     )
  //                   ) {
  //                   } else {
  ...
  //                         emptyFields[0].getAttribute("name") == "fleet_size" ||
  ...
  //                         document
  //                           .querySelector(
  //                             ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.multiple_region"
  //                           )
  ...
  //                 if (
  //                   document.querySelector(
  //                     ".spz_t14002_TC .formPopup form#generic-lead-form .secondfieldsWrapper h2"
  //                   )
  //                 ) {
  //                   document
  //                     .querySelector(
  ...
  //               if (
  //                 document.querySelector(
  //                   '.spz_t14002_TC .formPopup form#generic-lead-form .stepCTAWrapper button[type="button"]:first-child'
  //                 )
  //               ) {
  //                 document
  //                   .querySelector(
  ...
  //                     document
  //                       .querySelectorAll(
  //                         ".spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.first-name input, .spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.last-name input, .spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.email input, .spz_t14002_TC .formPopup form#generic-lead-form .fieldsWrapper .form-field.title input"
  //                       )
  //                       .forEach((visible) => {
  //                         if (visible.value == "") {
  //                           othersFilled = false;
  ...
  //           ".spz_t14002_TC .formPopup form#generic-lead-form"
  //         );
  //         if (form) {
  ...
  //               if (
  //                 !event.target.classList.contains("spz_t14002_TC") &&
  //                 !event.target.closest("button") &&
  //                 !event.target.closest('.stepCTAWrapper button[type="submit"]')
  //               ) {
  ...
  //             document
  //               .querySelectorAll(
  //                 '.spz_t14002_TC .formPopup form#generic-lead-form .form-field div[aria-haspopup="listbox"] + input'
  //               )
